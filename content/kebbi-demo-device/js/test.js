!async function () {
  ...
  // MQTT
  let robotChannel = 'deviceID/robot';
  let rfidChannel = 'deviceID/rfid';
  ...
  if (!webduinoBroadcastor) {
    ...
    robotChannel = robotChannel.replace('deviceID',urlParse['deviceID'])
    rfidChannel = rfidChannel.replace('deviceID',urlParse['deviceID'])
    console.log('robotChannel:'+robotChannel);
    console.log('rfidChannel:'+rfidChannel);
    console.log('mqtt ok');
  }

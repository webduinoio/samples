+(function (factory) {
  ...
  function getCarTracker(board, slPin, smPin, srPin, mlfPin, mlbPin, mrfPin, mrbPin) {
    return new webduino.module.CarTracker(board, slPin, smPin, srPin, mlfPin, mlbPin, mrfPin, mrbPin);
  }

  function getDrawTrack(canvasId, callback) {
    return new webduino.module.DrawTrack(canvasId, callback);
  }
  ...
  scope.getCarTracker = getCarTracker;
  scope.getDrawTrack = getDrawTrack;
